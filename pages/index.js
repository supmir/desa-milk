    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 px-2 gap-x-2">
      <div className="flex flex-col mx-auto max-h-screen">
        ...
        <div className="text-center visible block sm:hidden">
          Select your quantity and click order now
        </div>
        <div className="text-center visible block sm:hidden">
          Pilih kuantiti anda dan klik pesan sekarang:
        </div>
      </div>
      <div className="flex flex-col w-full m-auto h-screen sm:overflow-y-scroll">
        ...
        <button
          className="border-2 border-black rounded-xl px-2 py-1 mx-auto w-full flex justify-center"
          onClick={() => {
        ...
        >
          ...
          <div className="my-auto">Order now</div>
        </button>
        <div className="h-10"></div>
      </div>
    </div>
